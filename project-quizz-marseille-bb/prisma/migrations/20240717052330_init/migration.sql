...
CREATE TABLE `Game` (
    ...
    `ownerGameId` VARCHAR(191) NOT NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Game` ADD CONSTRAINT `Game_ownerGameId_fkey` FOREIGN KEY (`ownerGameId`) REFERENCES `User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
